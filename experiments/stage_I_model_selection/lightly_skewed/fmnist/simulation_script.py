...
DATASET_PATH = r'/home/maciejzuziak/raid/MIA_SHAP/experiments/datasets/lightly_skewed/fmnist/FMNIST_8_dataset_pointers'
...
ARCHIVE_NAME = 'withoutDP_lightly_modeltest'
...
def integration_test():
    ...
    optimizer_architecture = partial(optim.Adam, lr=LEARNING_RATE)
