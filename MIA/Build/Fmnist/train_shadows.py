...
def train_model(args):
    ...
    # Dataset setup
    dataset = FashionProductDataset(data_dir=args.data_dir, class_mapping=class_mapping, transform=train_transform)
    dataloader = DataLoader(dataset, batch_size=args.batch_size, shuffle=True)

    # Model setup
    model = ShadowModel(num_classes=len(class_mapping)).to(args.device)
